...
public class ResponseFacade 
    ...
    // ------------------------------------------- Added ServletResponse Methods
    // export JBOSS=/JBoss/jboss-5.1.0.GA
    // # explode target JAR (jbossweb.jar)
    // cd $JBOSS/server/custom/deploy/jbossweb.sar
    // mv jbossweb.jar jbossweb
    // mkdir jbossweb.jar
    // cd jbossweb.jar
    // jar xf ../jbossweb
    // # compile source directly into target JAR
    // cd SOURCE_ROOT
    // javac -source 1.5
    //  -d $JBOSS/server/custom/deploy/jbossweb.sar/jbossweb.jar
    //  -classpath $JBOSS/server/custom/deploy/jbossweb.sar/jbossweb.jar
    //   :$JBOSS/common/lib/servlet-api.jar
